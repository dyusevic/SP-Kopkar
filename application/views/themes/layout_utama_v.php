		...
		<nav class="navbar navbar-static-top" role="navigation">
			...
			<div class="navbar-right">
				<ul class="nav navbar-nav">
					...
					<a href="<?php echo base_url().'uploads/permen/permen_kukm_nomor_15_tahun_2015_tentang_usp_oleh_koperasi.pdf';?>" target="_newblank" class="navbar-btn sidebar-toggle"  role="button"> <i class="fa fa-book"></i>PP 15/KUKM/2015</a>
