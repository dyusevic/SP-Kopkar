...
<head>
	<meta charset="UTF-8">
	<title>Login-SIFOR KOPKAR</title>
	<!--<link rel="shortcut icon" href="<?php echo base_url().'assets/asset/images/Arnawa_Apps icon.png'; ?>" type="image/x-icon" />-->
...
<body>
	...
	<div class="form-box" id="login-box">
		<div class="header"><img height='45' src="<?php echo base_url().'assets/asset/images/samudera_logo.png'; ?>"></div>
		<form action="" method="post">
			...
			<div class="footer">
				&copy; Copyright <?php echo date('Y'); ?> | Developed by Arnintech.
			</div>
		</form>
	</div>
